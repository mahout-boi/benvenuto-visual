...
const tiposEvento = [
  {
    icon: "💍",
    titulo: "Aniversários",
    descricao: "Celebramos junto com você com uma proposta única, cheia de afeto, vinho e momentos que ficam na memória.",
  },
  {
    icon: "👨‍👩‍👧‍👦",
    titulo: "Reuniões de Família",
    descricao: "Para os casos que sonham com um dia inesquecível, o Benvenuto está pronto para transformar cada reunião em uma experiência única.",
  },
  {
    icon: "🎊",
    titulo: "Celebrações Especiais",
    descricao: "Formaturas, noivados, conquistas ou qualquer motivo para brindar. Cada celebração merece atenção, cuidado e afeto.",
  },
  {
    icon: "🍷",
    titulo: "Confraternizações",
    descricao: "Para os casos que sonham com um dia inesquecível. Cuidamos de cada detalhe para que o grande dia seja repleto de sabor, elegância e emoção.",
  },
];
...
const diferenciais = [
  {
    ...
    descricao: "Cada menu é pensado de acordo com o seu momento especial. Adaptamos pratos, estilos e harmonizações para que cada preferência reflita seus gostos, sua história e o clima da celebração.",
    img: restauranteImg,
  },
  {
    titulo: "Ambiente Privativo",
    descricao: "Oferecemos espaços reservados para quem busca mais intimidade e conforto. Um ambiente exclusivo e cuidadosamente escolhido, perfeito para viver o momento com quem realmente importa.",
    img: mesaImg,
  },
  {
    titulo: "Liberdade na Decoração",
    descricao: "Aqui, a celebração tem a sua assinatura. Damos liberdade para que a decoração traduz exatamente o que você sente, criando um ambiente com seu sentido para você e para o seu evento.",
    img: eventosImg,
  },
];
    ...
    <div className="bg-background">
      ...
      <section className="relative h-[70vh] min-h-[480px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
          ...
          <h1 className="font-playfair-display text-5xl font-light leading-tight text-white md:text-7xl">
            Eventos
          </h1>
      ...
      <section className="py-20 md:py-28">
        <div
          ...
          className={`mx-auto max-w-3xl px-6 text-center ${fadeUp} ${missaoSection.visible ? fadeIn : ""}`}
        >
      ...
      <section className="bg-secondary/30 py-20 md:py-28">
        <div
          ref={heroSection.ref}
          className={`mx-auto max-w-6xl px-6 ${fadeUp} ${heroSection.visible ? fadeIn : ""}`}
        >
          <div className="grid gap-12 md:grid-cols-2 md:gap-20 items-center">
            <div>
              ...
              <h2 className="mt-4 font-playfair-display text-3xl font-light leading-snug md:text-4xl">
      ...
      <section className="py-20 md:py-28">
        <div
          ...
          className={`mx-auto max-w-6xl px-6 ${fadeUp} ${tiposSection.visible ? fadeIn : ""}`}
        >
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {tiposEvento.map((tipo) => (
              <div
                key={tipo.titulo}
                className="group rounded-lg border border-border/60 p-7 hover:border-accent/50 hover:shadow-sm transition-all duration-300 bg-background"
              >
                <span className="text-3xl">{tipo.icon}</span>
                <h3 className="mt-4 font-playfair-display text-lg font-light">
                  {tipo.titulo}
                </h3>
      ...
      <section className="bg-secondary/30 py-20 md:py-28">
        <div
          ...
          className={`mx-auto max-w-6xl px-6 ${fadeUp} ${diferencialSection.visible ? fadeIn : ""}`}
        >
          <div className="text-center mb-14">
            <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">
          ...
          <div className="grid gap-10 md:grid-cols-3">
            {diferenciais.map((d) => (
              <div key={d.titulo} className="flex flex-col gap-5">
                ...
                <div>
                  <h3 className="font-playfair-display text-xl font-light">{d.titulo}</h3>
      ...
      <section className="py-20 md:py-28">
        <div
          ref={ctaSection.ref}
          className={`mx-auto max-w-2xl px-6 text-center ${fadeUp} ${ctaSection.visible ? fadeIn : ""}`}
        >
          <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2 rounded-full bg-foreground px-8 py-3.5 text-xs uppercase tracking-[0.2em] text-background transition-opacity hover:opacity-80"
          >
            Fale Conosco
          </a>
        </div>
